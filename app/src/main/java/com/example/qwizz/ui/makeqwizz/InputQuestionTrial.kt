...
//
//    var question = qwizzViewModel.question
//    var answer1 by remember { mutableStateOf(qwizzViewModel.answer1) }
//    var answer2 by remember { mutableStateOf(qwizzViewModel.answer2) }
//    var answer3 by remember { mutableStateOf(qwizzViewModel.answer3) }
//    var answer4 by remember { mutableStateOf(qwizzViewModel.answer4) }
//
//    var countCheck by remember { mutableIntStateOf(qwizzViewModel.countCheck) }
//
//    var isAnswer1Correct by remember { mutableStateOf(qwizzViewModel.isAnswer1Correct) }
//    var isAnswer2Correct by remember { mutableStateOf(qwizzViewModel.isAnswer2Correct) }
//    var isAnswer3Correct by remember { mutableStateOf(qwizzViewModel.isAnswer3Correct) }
//    var isAnswer4Correct by remember { mutableStateOf(qwizzViewModel.isAnswer4Correct) }
//
//
//    var allQuizQuestion = remember { mutableListOf<QuizQuestion>() }
//    var currentEditingIndex by remember { mutableIntStateOf(qwizzViewModel.currentEditingIndex) }
//
//
//
//
...
//                qwizzViewModel.resetUIForNewQuestion()
...
//                                            qwizzViewModel.loadQuestionDataIntoUI(currentEditingIndex)
//                                            countCheck = if (isAnswer1Correct || isAnswer2Correct || isAnswer3Correct || isAnswer4Correct) 1 else 0
//                                            currentEditingIndex--
...
//                                            qwizzViewModel.resetUIForNewQuestion()
//                                            //load
//                                            qwizzViewModel.loadQuestionDataIntoUI(nextIndex+1)
//                                            return@Button
//                                        }
//                                    },
